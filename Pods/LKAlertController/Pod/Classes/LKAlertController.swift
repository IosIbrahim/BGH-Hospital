...
//        if(required) {
//            NotificationCenter.default.addObserver(forName: UITextField.NSNotification.Name.UITextFieldTextDidChange, object: field, queue: OperationQueue.main) { (notification) in
