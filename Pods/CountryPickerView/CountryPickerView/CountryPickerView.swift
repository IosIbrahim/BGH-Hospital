...
//        if UserDefaults.standard.object(forKey: "Language") as? String ?? "" == "ar" {
//            
//        }
        setup()
    }
    ...
    public func initWithArabic() {
        self.view.transform = CGAffineTransform(scaleX: -1, y: 1)
        flagImageView.transform = CGAffineTransform(scaleX: -1, y: 1)
        countryDetailsLabel.transform = CGAffineTransform(scaleX: -1, y: 1)
    }
