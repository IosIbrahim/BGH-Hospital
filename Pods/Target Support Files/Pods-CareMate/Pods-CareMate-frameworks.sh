...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GiFHUD-Swift/GiFHUD_Swift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleDataTransport/GoogleDataTransport.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleUtilities/GoogleUtilities.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HRRoundAndBorderedView/HRRoundAndBorderedView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/IQKeyboardManagerSwift/IQKeyboardManagerSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/JNPhoneNumberView/JNPhoneNumberView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NitroNSDictionaryCategories/NitroNSDictionaryCategories.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NitroUIColorCategories/NitroUIColorCategories.framework"
